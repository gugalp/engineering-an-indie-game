...
This repository is a **developer journal** covering topics such as:

- game design and architecture
- solo development challenges
- using AI tools to support development
- building a production pipeline for assets
- learning disciplines outside my comfort zone
...
Keeping these posts in a Git repository allows:
...
These posts are also shared on:
